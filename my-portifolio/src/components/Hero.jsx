  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center relative animate-fade-in">
      <div className="flex items-center justify-center text-left gap-8 z-10 relative">
        ...
        <div className="">
          <h1 className="max-w-150 text-font font-main text-5xl font-medium relative">
            Oie, eu sou a{" "}
            <span className="bg-linear-to-r from-purple via-blue-400 to-blue bg-clip-text text-transparent font-bold">
              Niethilley
            </span>{" "}
      ...
      <div className="flex justify-center gap-10 mt-12 z-10 align-center relative items-center ">
        ...
        <button className="bg-font font-main font-medium text-main-bg px-6 py-2 rounded-md hover:bg-main-bg hover:text-font transition-colors border border-borders cursor-pointer">
          Currículo
        </button>
      </div>
