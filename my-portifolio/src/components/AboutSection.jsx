...
const AboutSection = () => {
  return (
    <div className="py-14 px-6 md:px-12 lg:px-24 max-w-330 mx-auto mb-30 mt-40">
      ...
      <div className="mt-30">
        <h4 className="mb-10 font-main text-font">Algumas tecnologias que uso e estudo</h4>
      </div>
      <DividerCarousel/>
    </div>
  );
